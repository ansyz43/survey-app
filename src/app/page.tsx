...
export default function Home() {
  ...
  const t = {
    zh: {
      title: '🎨 创意产业调查',
      desc: '我们正在研究中国市场对来自俄罗斯远东地区创意产业的需求。',
    ...
    ru: {
      title: '🎨 Исследование креативных индустрий',
      desc: 'Мы изучаем спрос на продукты креативных индустрий Дальнего Востока России на китайском рынке.',
