...
export async function runAnalysis(customPrompt?: string) {
  ...
  const systemPrompt = customPrompt || `Ты — аналитик маркетинговых исследований. Тебе даны результаты опроса ${responses.length} китайских респондентов (студенты на Дальнем Востоке России).

Задача: определить, какой креативный контент (музыка, фото, видео) команда с Дальнего Востока России может создавать и продавать на китайском рынке.
